...
#include "Wire.h"
#include "font/bmz6x16.h"
#include "font/bmz4x6.h"
#include "font/bmz5x7.h"
#include "font/bmz6x7.h"
#include "font/bmzSegment16.h"
...
void loop()
  { 
   ...
   dwMrq(msgPuasa(hd_puasa,ty_puasa),50,0,5);                  // addr: 5 show Remander Puasa
   drawSholat(6);                                              // addr: 5 show sholat time
   dwMrq(drawInfo(130)    ,50,1,7);                             // addr: 6 show Info 1
    anim_DT(8);                                                 // addr: 7 show date time    
    dwMrq(drawInfo(280)   ,50,2,9);                             // addr: 8 show Info 2 
    drawSholat(10);                                              // addr: 9 show sholat time
    dwMrq(drawInfo(430)   ,50,1,11);                           // addr: 10 show Info 3
...
//  if(RunFinish==3) {RunSel = 3; RunFinish =0;}
    ...
    {if (ty_puasa!=0)  {RunSel = 5; RunFinish =0;}
        else {RunSel = 6; RunFinish =0;}}                             //after anim 4 set anim 5
    ...
    if(RunFinish==10) {RunSel = 11;  RunFinish =0;}
    if(RunFinish==11) {RunSel = 1;  RunFinish =0;}                    //after anim 10 set anim 1
